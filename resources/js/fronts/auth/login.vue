    ...
    <div class="modal">
        <div class="modal-container">
            <div class="modal-left">
                ...
                <div v-if="error" class="login__window__error">
                    <p>{{ error }}</p>
                </div>
                ...
                <div class="modal-buttons">
                    ...
                    <button type="button" @click="login" class="input-button">Login</button>
                </div>
        ...
        <button type="button" class="modal-button">Click here to login</button>
    </div>
</template>
